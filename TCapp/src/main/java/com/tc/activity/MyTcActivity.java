...
public class MyTcActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void init() {
        new HeaderHolder().init(this, "我的吐槽").hideRightText();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(MyTcActivity.this, TcContentDetailActivity.class);
    ...
    private void getContentData(final boolean refresh) {
        ...
        RequestParams params = new RequestParams(Config.SERVER_API_URL + "user/getTcContentListByUserId");
        ...
        x.http().get(params, new Callback.CommonCallback<String>() {
            ...
            public void onError(Throwable ex, boolean isOnCallback) {
                ...
                CommonUtil.toast(MyTcActivity.this, Constant.NETWORK_ERROR);
            }
