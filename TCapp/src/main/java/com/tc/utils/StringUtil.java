...
public class StringUtil {
    ...
    /**
     * Encode a string using algorithm specified in activity_webivity_web.xml and return the
     * resulting encrypted password. If exception, the plain credentials string
     * is returned
     *
     * @param password  Password or other credentials to use in authenticating this
     *                  username
     * @param algorithm Algorithm used to do the digest eg: "md5"
     ...
     * 参数为空校验
     *
     * @return false:参数为空 true:校验通过
     */
    public static boolean paramNull(Context context,Require require) {
